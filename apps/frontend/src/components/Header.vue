<template>
    <div class="header">
        ...
        <div class="header-actions">
            <button @click="handleConnect" class="action-btn primary" :disabled="loading">
                <span class="btn-text">{{ isConnected ? 'Disconnect' : 'Connect' }}</span>
            </button>

            <button @click="handlePing" class="action-btn secondary" :disabled="!isConnected || loading">
            ...
            <!-- Health Indicator -->
            <div class="health-indicator" v-if="isStreaming" :class="{ healthy: isStreamHealthy }">
